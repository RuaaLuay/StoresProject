        ...
        <div class="row tm-content-row">
            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 tm-block-col">
                <div class="tm-bg-primary-dark tm-block tm-block-product-categories">
                    <form action="{{url('dashboard/product/deleteSelected')}}" method="post" class="tm-edit-product-form" id="items-form">
                        @csrf
                            ...
                            <table class="table table-hover tm-table-small tm-product-table">
                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                                <form action="{{ URL('dashboard/product/delete/'.$product->id) }}"
                                                      method="POST">
                                                    @csrf
                                                    <button type="submit"
                        ...
                        <a href="{{url('dashboard/product/create')}}" class="btn btn-primary btn-block text-uppercase mb-3">Add new product</a>
                        <button type="submit"
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 tm-block-col">
                <div class="tm-bg-primary-dark tm-block tm-block-product-categories">
                    <form action="{{url('dashboard/product/restoreSelected')}}" method="post" class="tm-edit-product-form" id="items-form">
                        @csrf
                        ...
                        <table class="table tm-table-small tm-product-table">
                            ...
                            @foreach ($trashedProducts as $trashedProduct)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ URL('dashboard/product/restore/'.$trashedProduct->id) }}"
                                              method="POST">
                                            @csrf
